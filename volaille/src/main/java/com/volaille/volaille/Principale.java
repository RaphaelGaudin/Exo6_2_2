...
public class Principale {
    public static void execute() {
        ...
        do {
            System.out.println("\n\nQue voulez-vous faire ? (q pour quitter)");
            ...
            switch (choice) {
                ...
                case "1":
                    ...
                    break;
                case "2":
                    elevage.afficherCanardsAAbattre();
                    scanner.nextLine();
                    break;
                case "3":
                    elevage.afficherPouletsAAbattre();
                    scanner.nextLine();
                    break;
                case "4":
                    elevage.afficherCanardsSousPoidsAbattage();
                    scanner.nextLine();
                    break;
                case "5":
                    elevage.afficherPouletsSousPoidsAbattage();
                    scanner.nextLine();
                    break;
                default:
                    break;
